...
#define NM_DEVICE_VRF_GET_PRIVATE(self) _NM_GET_PRIVATE (self, NMDeviceVrf, NM_IS_DEVICE_VRF)
...
unrealize_notify (NMDevice *device)
{
	...
	memset (&priv->props, 0, sizeof (NMPlatformLnkVrf));
                    ...
                    GError **error)
{
	...
	s_vrf = (NMSettingVrf *) nm_connection_get_setting (connection,
	                                                    NM_TYPE_SETTING_VRF);
	nm_assert (s_vrf);
...
{
	NMDeviceVrfPrivate *priv = NM_DEVICE_VRF_GET_PRIVATE ((NMDeviceVrf *) device);
	NMSettingVrf *s_vrf;
...
{
	NMDeviceVrfPrivate *priv = NM_DEVICE_VRF_GET_PRIVATE ((NMDeviceVrf *) device);
	NMSettingVrf *s_vrf = (NMSettingVrf *) nm_connection_get_setting (connection, NM_TYPE_SETTING_VRF);
...
{
	NMDeviceVrfPrivate *priv = NM_DEVICE_VRF_GET_PRIVATE ((NMDeviceVrf *) object);
...
create_device (NMDeviceFactory *factory,
               ...
               gboolean *out_ignore)
{
	return (NMDevice *) g_object_new (NM_TYPE_DEVICE_VRF,
